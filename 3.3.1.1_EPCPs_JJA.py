...
cnn_res_JJA = cnn_res[np.isin(cnn_res.index.month, [6, 7, 8])]
...
#%%
msl = read_dataarray('msl').loc[cnn_res_JJA.index, para.lat_circ, para.lon_circ]
z500 = read_dataarray('z', 500).loc[cnn_res_JJA.index, para.lat_circ, para.lon_circ]
u850 = read_dataarray('u', 850).loc[cnn_res_JJA.index, para.lat_circ, para.lon_circ][:, ::3, ::3]
v850 = read_dataarray('v', 850).loc[cnn_res_JJA.index, para.lat_circ, para.lon_circ][:, ::3, ::3]
u500 = read_dataarray('u', 500).loc[cnn_res_JJA.index, para.lat_circ, para.lon_circ][:, ::3, ::3]
v500 = read_dataarray('v', 500).loc[cnn_res_JJA.index, para.lat_circ, para.lon_circ][:, ::3, ::3]
...
#%%
epcp = cnn_res_JJA.index[cnn_res_JJA.predict_ep==1]
extr = cnn_res_JJA.index[cnn_res_JJA.true_ep==1]
...
titles = ['Z500&uv500 EPCP JJA', 'SLP&uv850 EPCP JJA', 'Z500&uv500 EPE-R JJA', 'SLP&uv850 EPE-R JJA']
