...
#%%
q = read_dataarray('q').loc[cnn_res_JJA.index, para.lat_circ, para.lon_circ]
divmf = read_dataarray('divmf').loc[cnn_res_JJA.index, para.lat_circ, para.lon_circ]
...
titles = ['q&uv850 EPCP JJA', 'divmf&uvmf EPCP JJA', 'q&uv850 EPE-R JJA', 'divmf&uvmf EPE-R JJA']
units  = ['', '', '', '']
