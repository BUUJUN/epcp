...
kwards_geo = dict(lonlat=[105, 125, 10, 30], 
...
def format_plot(ax, title='', unit=''):
    ...
    ax.plot([108, 118, 118, 108, 108], [18, 18, 26, 26, 18], color='k')
...
epcp = cnn_res.index[cnn_res.true_ep==1]
