...
GEPE_in_REPE_AM = PREC_ds_AM.ep_day.where(PREC_ds_AM.ep_day_sc==1)
PREC_in_REPE_AM = PREC_ds_AM.prec.where(PREC_ds_AM.ep_day_sc==1)
P_REPE_AM = PREC_in_REPE_AM.where(GEPE_in_REPE_AM==1).mean(dim=['lon','lat'])
...
GEPE_in_REPE_JJA = PREC_ds_JJA.ep_day.where(PREC_ds_JJA.ep_day_sc==1)
PREC_in_REPE_JJA = PREC_ds_JJA.prec.where(PREC_ds_JJA.ep_day_sc==1)
P_REPE_JJA = PREC_in_REPE_JJA.where(GEPE_in_REPE_JJA==1).mean(dim=['lon','lat'])
...
fig.savefig('./pics/FIG9_定量贡献分解_REPE_EPE.png')
fig.show()
