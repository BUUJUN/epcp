...
#%%
def sum_plot(axes, data_year:xr.DataArray, data_mon:xr.DataArray, ylabel_1):
...
fig, axes = pplt.subplots(
    [[1, 4, 7, 10], 
     [2, 5, 8, 11], 
     [3, 6, 9, 12]], figsize=(20, 10), hspace=(0, None), dpi=100)
axes.format(abcloc='ul')
sum_plot(axes[0:3], to_prec_yr, to_prec_mon, 'Total prec. (mm/AMJJA)')
sum_plot(axes[3:6], ep_prec_yr, ep_prec_mon, 'Total extr. prec. (mm/AMJJA)')
sum_plot(axes[6:9], ep_freq_yr, ep_freq_mon, 'EPE-R frequency (days/AMJJA)')
intensity_plot(axes[9:11], ep_inte_yr, ep_inte_mon, 'EPE-R intensity (mm/day)')
...
fig, axes = pplt.subplots(
    [[1, 4, 7, 10], 
     ...
     [3, 6, 9, 12]], figsize=(20, 10), hspace=(0, None), dpi=100)
axes.format(abcloc='ul')
sum_plot(axes[0:3], to_prec_yr_sc, to_prec_mon_sc, 'Total prec. (mm/AMJJA)')
sum_plot(axes[3:6], ep_prec_yr_sc, ep_prec_mon_sc, 'Total extr. prec. (mm/AMJJA)')
sum_plot(axes[6:9], ep_freq_yr_sc, ep_freq_mon_sc, 'EPE-R frequency (days/AMJJA)')
intensity_plot(axes[9:11], ep_inte_yr_sc, ep_inte_mon_sc, 'EPE-R intensity (mm/day)')
